...
@interface LimitThreeTableViewController ()
@property (nonatomic, strong) NSMutableArray *listArr;
@property (nonatomic, assign) BOOL upOrDown;
@end
@implementation LimitThreeTableViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loadData {
    ...
    NSDictionary *para = @{@"userid":[HWUtil isBlankString:userid]?@"":userid, @"relationtype":@"已申请"};
