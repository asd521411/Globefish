...
@interface LimitFiveTableViewController ()
@property (nonatomic, strong) NSMutableArray *listArr;
@property (nonatomic, assign) BOOL upOrDown;
@end
@implementation LimitFiveTableViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loadData {
    ...
    NSDictionary *para = @{@"userid":[HWUtil isBlankString:userid]?@"":userid, @"relationtype":@"收藏"};
