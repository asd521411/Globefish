...
@interface LimitTwoTableViewController ()
@property (nonatomic, strong) NSMutableArray *listArr;
@property (nonatomic, assign) BOOL upOrDown;
@end
@implementation LimitTwoTableViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loadData {
    ...
    NSDictionary *para = @{@"userid":[HWUtil isBlankString:userid]?@"":userid, @"relationtype":@"我看过"};
